...
class RegisterUserModel {
  String message; // pesan dari server (mis. "success" atau alasan error)
  Data data; // payload utama (token, user, profilePhotoUrl)
...
class Data {
  String token; // token auth (Bearer token)
  User user; // info user yg baru register
  String? profilePhotoUrl; // url foto profil di server
